...
const KNOWN_DEFAULTS: Record<string, AdapterCapabilities> = {
  ...
  kilocode_local: { supportsInstructionsBundle: true, supportsSkills: true, supportsLocalAgentJwt: true, requiresMaterializedRuntimeSkills: true, supportsAcp: false },
