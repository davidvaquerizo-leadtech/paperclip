...
export {
  OPENCODE_FLAVOR,
  OPENCODE_SANDBOX_INSTALL_COMMAND,
  isValidOpenCodeFamilyModelId,
  type OpenCodeFlavor,
} from "./flavor.js";
import { OPENCODE_SANDBOX_INSTALL_COMMAND, isValidOpenCodeFamilyModelId } from "./flavor.js";

/** Sandbox install command for the OpenCode CLI. See `flavor.ts` for the rationale. */
export const SANDBOX_INSTALL_COMMAND = OPENCODE_SANDBOX_INSTALL_COMMAND;
