...
adapter_type: ("process" | "http" | "acpx_local" | "claude_local" | "codex_local" | "cursor_cloud" | "gemini_local" | "hermes_gateway" | "hermes_local" | "opencode_local" | "pi_local" | "cursor" | "openclaw_gateway" | "grok_local" | "kimi_local" | "kilocode_local" | "other")
agent_id: string
agent_role: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
model?: string
task_id?: string
...
export const PAPERCLIP_ENUM_DESCRIPTIONS = {
  ...
  "agent.task_completed": {
    "adapter_type": {
      ...
      "kilocode_local": "Agent runtime uses the local Kilo Code adapter.",
